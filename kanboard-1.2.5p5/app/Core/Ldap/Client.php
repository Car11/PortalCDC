...
class Client
{
    ...
    {
        //
        self::$connData = explode("@", $username);
        // $connData[0]: username.
        // $connData[1]: server.
        if(count(self::$connData)<2) 
            throw new ClientException('Domain: Set @domain name.');
        //
        $client = new static;
    ...
    public function authenticate($bind_rdn, $bind_password)
    {
        ...
        $GLOBALS['baseDn_DC']= preg_split( "/[\@,.]+/", $bind_rdn )[1]; // dominio.
        return true;
    }
    ...
    public function getLdapServer()
    {
        ...
        return sprintf(LDAP_SERVER, self::$connData[1]);
        // return LDAP_SERVER;
    }
