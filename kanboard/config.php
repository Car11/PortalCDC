...
define('MAIL_FROM', 'operTI@ice.go.cr');
...
define('DB_USERNAME', 'operkb');

// Mysql/Postgres password
define('DB_PASSWORD', 'DQReGasUJuuQ8JwZ');
...
// define('LDAP_SERVER', 'icetel.ice');
define('LDAP_SERVER', '%s');
...
//define('LDAP_USERNAME', '%s@icetel.ice');
...
// define('LDAP_USER_BASE_DN', 'DC=icetel,DC=ice');
define('LDAP_USER_BASE_DN', 'DC=%s,DC=ice');
...
//define('LDAP_USER_ATTRIBUTE_USERNAME', 'uid');original
