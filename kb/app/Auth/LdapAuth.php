...
class LdapAuth extends Base implements PasswordAuthenticationProviderInterface
{
    ...
    public function authenticate()
    {
        try {
            ...
            $client = LdapClient::connect($this->getLdapUsername(), $this->getLdapPassword(),$this->getLdapDominio());
    ...
    public function getLdapUsername()
    {
        switch ($this->getLdapBindType()) {
            ...
            case 'user':
                // "jaroja4" . $dom;
                // LDAP_USERNAME = $this->dominio;
                return sprintf($this->username . "@" . $this->dominio);
